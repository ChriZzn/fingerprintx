...
// ServiceInfluxDB holds metadata for InfluxDB detection
...
func (p *InfluxDBPlugin) Run(conn *plugins.FingerprintConn, timeout time.Duration, target plugins.Target) (*plugins.Service, error) {
...
// Ports returns the default ports for InfluxDB
func (p *InfluxDBPlugin) Ports() []uint16 {
	return []uint16{8086}
}
